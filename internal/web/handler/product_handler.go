...
func NewProductHandler(validator *validator.Validate, service productservice.ProductService, logger *slog.Logger) *ProductHandler {
...
func (h *ProductHandler) Update(c *gin.Context) {
	...
	if err != nil {
		...
		if errors.Is(err, ErrAmountIsNegative) {
