...
func NewProductRepository(db *pgxpool.Pool, log *slog.Logger) product.ProductRepository {
...
func (r *productRepository) UnsetCategory(ctx context.Context, category uuid.UUID) error {
