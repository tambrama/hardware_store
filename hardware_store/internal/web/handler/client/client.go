...
import (
	...
	service "hardware_store/internal/service/client"
...
func NewClientHandler(validator *validator.Validate, service service.ClientService) *ClientHandler {
	return &ClientHandler{validator: validator, service: service}
}
